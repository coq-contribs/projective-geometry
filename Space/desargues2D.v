...
Proof.
generalize rA'B'O';intro rA'B'O'.
generalize rA'C'O';intro rA'C'O'.
generalize rB'C'O';intro rB'C'O'.
...
(* alpha *)
apply (beta_ok' B' A' C' B A C O) with (P:=P) (o:=o) (alpha:=beta) (gamma:=gamma) (b:=a); try eauto with rk.
