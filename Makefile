...
.PHONY: all opt byte archclean clean install depend html Plane Space
...
install:
	...
	(cd Plane; $(MAKE) INSTALLDEFAULTROOT=$(INSTALLDEFAULTROOT)/Plane install)
	(cd Space; $(MAKE) INSTALLDEFAULTROOT=$(INSTALLDEFAULTROOT)/Space install)
...
archclean:
	rm -f *.cmx *.o
	(cd Plane ; $(MAKE) archclean)
	(cd Space ; $(MAKE) archclean)
...
Makefile: Make
	...
	(cd Plane ; $(MAKE) Makefile)
	(cd Space ; $(MAKE) Makefile)
